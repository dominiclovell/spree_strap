  ...
  module CheckoutHelper
    ...
    def checkout_progress
      ...
      items = states.map do |state|
        ...
        content_tag('li', content_tag('span', text), class: css_classes.join(' ') + ' list-group-item')
      end
      content_tag('ol', raw(items.join("\n")), class: 'progress-steps list-group list-group-inline', id: "checkout-step-#{@order.state}")
    end
  end
end