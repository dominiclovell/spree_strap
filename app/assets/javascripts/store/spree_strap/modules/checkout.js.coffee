...
Spree.ready ($) ->
  ...
  if ($ '#checkout_form_address').is('*')
    ...
    # This is not ideal but for some reason the jqueryValidate invalidHandler wasn't working
    $("#checkout_form_address").bind 'invalid-form.validate', (event, validator)->
      setTimeout ->
